...
void maegamiInit() {
	himgoriginal = himg[0][0] = LoadGraph("gazo/5前髪/KGR_前髪_1A.png");
	himg[0][1] = LoadGraph("gazo/5前髪/KGR_前髪_1A_2.png");
	himg[0][2] = LoadGraph("gazo/5前髪/KGR_前髪_2A.png");
	himg[0][3] = LoadGraph("gazo/5前髪/KGR_前髪_2A_2.png");
	himg[0][4] = LoadGraph("gazo/5前髪/KGR_前髪_3A.png");
	himg[0][5] = LoadGraph("gazo/5前髪/KGR_前髪_3A_2.png");
	himg[1][0] = LoadGraph("gazo/5前髪/KGR_前髪_4A.png");
	himg[1][1] = LoadGraph("gazo/5前髪/KGR_前髪_4A_2.png");
	himg[1][2] = LoadGraph("gazo/5前髪/KGR_前髪_でこA.png");
	himg[1][3] = LoadGraph("gazo/5前髪/KGR_前髪_でこA_2.png");
	himg[1][4] = LoadGraph("gazo/5前髪/KGR_前髪_でこB.png");
	himg[1][5] = LoadGraph("gazo/5前髪/KGR_前髪_でこB_2.png");
	//選択項目
	himgflug[0][0] = true;
	colorsInit();
	r = 255;
