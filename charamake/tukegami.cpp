...
void tukegamiInit() {
	...
	himg[0][1] = LoadGraph("gazo/8付け毛/KGR_ツインテール.png");
	himg[0][2] = LoadGraph("gazo/8付け毛/KGR_ツインテール_2.png");
	himg[0][3] = LoadGraph("gazo/8付け毛/KGR_ハーフアップ.png");
	himg[0][4] = LoadGraph("gazo/8付け毛/KGR_ハーフアップ_2.png");
	himg[0][5] = LoadGraph("gazo/8付け毛/KGR_ハーフテール右.png");
	himg[1][0] = LoadGraph("gazo/8付け毛/KGR_ハーフテール右_2.png");
	himg[1][1] = LoadGraph("gazo/8付け毛/KGR_ハーフテール左.png");
	himg[1][2] = LoadGraph("gazo/8付け毛/KGR_ハーフテール左_2.png");
	himg[1][3] = LoadGraph("gazo/8付け毛/KGR_後結び.png");
	himg[1][4] = LoadGraph("gazo/8付け毛/KGR_後結び_2.png");
	himg[1][5] = LoadGraph("gazo/8付け毛/KGR_付け毛_お団子.png");
	himg[2][0] = LoadGraph("gazo/8付け毛/KGR_付け毛_お団子_2.png");
	himg[2][1] = LoadGraph("gazo/8付け毛/KGR_付け毛_ポニーテール.png");
	himg[2][2] = LoadGraph("gazo/8付け毛/KGR_付け毛_ポニーテール_2.png");

	hsitaimgoriginal=hsitaimg[0][0] = -1;
	hsitaimg[0][1] = LoadGraph("gazo/8付け毛/KGR_ツインテール$.png");
	hsitaimg[0][2] = LoadGraph("gazo/8付け毛/KGR_ツインテール_2$.png");
	hsitaimg[0][3] = -1;
	hsitaimg[0][4] = -1;
	hsitaimg[0][5] = LoadGraph("gazo/8付け毛/KGR_ハーフテール右$.png");
	hsitaimg[1][0] = LoadGraph("gazo/8付け毛/KGR_ハーフテール右_2$.png");
	hsitaimg[1][1] = LoadGraph("gazo/8付け毛/KGR_ハーフテール左$.png");
	hsitaimg[1][2] = LoadGraph("gazo/8付け毛/KGR_ハーフテール左_2$.png");
	hsitaimg[1][3] = LoadGraph("gazo/8付け毛/KGR_後結び$.png");
	hsitaimg[1][4] = LoadGraph("gazo/8付け毛/KGR_後結び_2$.png");
	hsitaimg[1][5] = LoadGraph("gazo/8付け毛/KGR_付け毛_お団子$.png");
	hsitaimg[2][0] = LoadGraph("gazo/8付け毛/KGR_付け毛_お団子_2$.png");
	hsitaimg[2][1] = LoadGraph("gazo/8付け毛/KGR_付け毛_ポニーテール$.png");
	hsitaimg[2][2] = LoadGraph("gazo/8付け毛/KGR_付け毛_ポニーテール_2$.png");
