...
void omakeInit() {
	...
	himg[0][1] = LoadGraph("gazo/10☆おまけ/chara.png");
	himg[0][2] = LoadGraph("gazo/10☆おまけ/t1.png");
	himg[0][3] = LoadGraph("gazo/10☆おまけ/t2.png");
	himg[0][4] = LoadGraph("gazo/10☆おまけ/t3.png");
	himg[0][5] = LoadGraph("gazo/10☆おまけ/t4.png");
	himg[1][0] = LoadGraph("gazo/10☆おまけ/t5.png");
	himg[1][1] = LoadGraph("gazo/10☆おまけ/t6.png");
	himg[1][2] = LoadGraph("gazo/10☆おまけ/t7.png");
	himg[1][3] = LoadGraph("gazo/10☆おまけ/t8.png");
	himg[1][4] = LoadGraph("gazo/10☆おまけ/t9.png");
	himg[1][5] = LoadGraph("gazo/10☆おまけ/t10.png");
	himg[2][0] = LoadGraph("gazo/10☆おまけ/t11.png");
	himg[2][1] = LoadGraph("gazo/10☆おまけ/t12.png");
	himg[2][2] = LoadGraph("gazo/10☆おまけ/t13.png");
	himg[2][3] = LoadGraph("gazo/10☆おまけ/t14.png");
	himg[2][4] = LoadGraph("gazo/10☆おまけ/t15.png");
	himg[2][5] = LoadGraph("gazo/10☆おまけ/t16.png");
	himg[3][0] = LoadGraph("gazo/10☆おまけ/t22.png");
	himg[3][1] = LoadGraph("gazo/10☆おまけ/t23.png");
	himg[3][2] = LoadGraph("gazo/10☆おまけ/t24.png");
	himg[3][3] = LoadGraph("gazo/10☆おまけ/t25.png");
	himg[3][4] = LoadGraph("gazo/10☆おまけ/t26.png");
	himg[3][5] = LoadGraph("gazo/10☆おまけ/t27.png");
